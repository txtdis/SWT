...
DROP ROLE IF EXISTS	josephine;
CREATE ROLE "josephine" LOGIN PASSWORD 'PHINE' NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE;
GRANT user_sales TO josephine;
