...
public class DepositSettlement extends Report {

	public DepositSettlement(Date[] dates, int routeId) {
		module = "Deposit/Transmittal Settlement";
		...
		data = new Data().getDataArray(new Object[] { dates[0], dates[1], routeId, DIS.CASHIER }, ""
				// @sql:on
				+ "WITH parameter\n" 
