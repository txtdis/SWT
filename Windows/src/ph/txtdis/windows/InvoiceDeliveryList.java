...
public class InvoiceDeliveryList extends Report {
	private Date[] dates;
	private int productLineId, outletId, itemId;
	...
	public InvoiceDeliveryList(Date[] dates, int itemId){
	...
	public static void main(String[] args) {
		...
		dates[1]= new Date(cal.getTimeInMillis());
		Object[][] aao = new InvoiceDeliveryList(dates, 109).getData();
